...
public class PopulationGenerator {
    ...
    Map<Double, Individual> Crossing(List<Individual> population) {
        ...
        for (int i = 0; i < limit/2; i++) {
            ...
            limit--;
            Individual c = new Individual(mpi, foodByCategory, objectiveCalories,bs,bs.cross(a.getId(), b.getId()));
            Individual d = new Individual(mpi, foodByCategory, objectiveCalories,bs,bs.cross(b.getId(), a.getId()));
            c.calculateHability();
            d.calculateHability();
    ...
    public Map<Double, Individual> Mutation(Map<Double, Individual> population2) {
        ...
        for (Map.Entry<Double, Individual> entry : population2.entrySet()) {
            ...
            for (Meal mealDistribution : mpi.getMealDistribution()) {
                ...
                Individual newIndividual = new Individual(mpi, foodByCategory, objectiveCalories, bs, newid);
